  ...
  if (user) {
    onValue(ref(db, `users/${user.uid}`), (snapshot) => {
      ...
      if (data.role == "Siswa") {
        ...
        <li class="nav-item me-3">
          <a class="nav-link" href="pages/materi_1/materi_1-1.html">Materi</a>
        </li>
        <li class="nav-item me-3">
        ...
        `;
        const mulaiBelajar = document.querySelector("#mulai");
        mulaiBelajar.addEventListener("click", () => {
      ...
      if (data.role == "Guru") {
        ...
        <li class="nav-item me-3">
          <a class="nav-link" href="pages/halaman_guru/dashboard-guru.html">Dashboard</a>
        </li>
        <li class="nav-item me-3">
          <a class="nav-link" href="../../tentang.html">Tentang</a>
        </li>
      ...
      if (data.role == "Admin") {
        ...
        <li class="nav-item me-3">
          <a class="nav-link" href="pages/halaman_admin/dashboard-guru.html">Dashboard</a>
        </li>
        <li class="nav-item me-3">
          <button class="nav-link green" style="border: none;" id="button-keluar">Logout</button>
        </li>
